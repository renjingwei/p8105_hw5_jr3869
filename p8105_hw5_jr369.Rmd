...
This dataset has `r nrow(homicide_data)` rows and `r ncol(homicide_data)` columns. Variables include reported date, each victim's information ,included id, names, race, age and sex, and   the location of the killing, included city, state, longitude and latitude and finally whether an arrest was made.
